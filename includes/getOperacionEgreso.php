<?php
	...
	$query = "SELECT id_operacion, descripcion_ope, tipo_ope, categoria_ope FROM operaciones WHERE categoria_ope = '$categoria_ope' AND tipo_ope='EGRESOS' AND descripcion_ope NOT LIKE '%FLETE%' ORDER BY descripcion_ope";

...
class MiPDF extends FPDF {
	...
	$mipdf -> Ln (2);
	$mipdf -> Cell('mm',10,utf8_decode("LISTA DE MANIFIESTOS DE CARGA POR DESTINATARIO"),0,0,'C');
	$mipdf -> Ln (10);

	$mipdf -> Setfont('Arial','B',10);
	$mipdf -> Ln (2);
	$mipdf -> Cell('mm',10,utf8_decode("DESTINATARIO DE MANIFIESTO DE CARGA: $destinatario."),0,0,'L');
	$mipdf -> Ln (2);

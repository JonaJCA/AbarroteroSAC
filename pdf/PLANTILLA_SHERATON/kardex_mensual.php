...
class MiPDF extends FPDF {
	...
	$cabeceraT = array("Fecha");
		...
		$mipdf -> Ln (2);
		$mipdf -> Cell(200,10,"Kardex del mes actual del socio $id a la fecha $fecha",0,0,'C');
		$mipdf -> Ln (10);
...
AND MONTH(movimientos.fecha_movimiento)=MONTH(CURDATE())
AND YEAR(movimientos.fecha_movimiento)=YEAR(CURDATE())

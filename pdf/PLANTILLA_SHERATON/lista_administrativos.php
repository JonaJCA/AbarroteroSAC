...
class MiPDF extends FPDF {
	...
	$cabeceraT = array("Fecha");
		...
		$mipdf -> Ln (2);
		$mipdf -> Cell(200,10,"Lista de egresos internos",0,0,'C');
		$mipdf -> Ln (10);

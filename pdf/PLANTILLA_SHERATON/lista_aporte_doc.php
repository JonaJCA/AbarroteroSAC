...
(CONCAT('S/',FORMAT(monto,2))) AS MONTO,
...
$sql2=$bd->consulta($sql);
	...
	$mipdf -> Setfont('Arial','B',12);
	$mipdf -> Ln (23);
	$mipdf -> Cell(190,10,"$documento",0,0,'C');
	$mipdf -> Ln (10);

	$mipdf -> Setfont('Arial','B',10);
	$mipdf -> Ln (10);	
 	$mipdf->MultiCell(190,7,"          YO, $socio IDENTIFICADO CON DNI N.$dni Y REGISTRADO CON CODIGO $codigo EN LA \"COOPERATIVA DE AHORRO Y CREDITO DE LOS TRABAJADORES DE LIMA SHERATON HOTEL\" CON CATEGORIA DE TIPO $categoria, CONFIRMO QUE SE HA REALIZADO UNA OPERACION DE $operacion CON UN MONTO DE $monto DE FORMA SATISFACTORIA DE ACUERDO A LO QUE SE ESTABLECE EN LA NORMATIVA Y POLITICAS DE LA COOPERATIVA, ASI COMO SE DECRETA EN LA LEY N.15171 ARTICULO N.1 DECRETO LEY N.85 ARTICULO N.79.");

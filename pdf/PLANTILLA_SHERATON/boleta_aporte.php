...
(case movimientos.operacion 
	when 'DEVOLUCION DE APORTE' THEN '01    DEVOLUCION' 
	ELSE CONCAT('01      ',movimientos.operacion) end) OPERACION, 
...
WHERE tipo_movimiento='APORTE' 
AND movimientos.operacion NOT LIKE '%ANULADO' 

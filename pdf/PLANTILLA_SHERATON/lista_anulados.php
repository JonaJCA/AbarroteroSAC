...
$hora = date('H:i:s a');
$fecha = date('d/m/Y ');
$usuario=$_SESSION['dondequeda_nombre'];
...
class MiPDF extends FPDF {
	...
	$cabeceraT = array("Fecha");
		...
		$mipdf -> Ln (2);
		$mipdf -> Cell(200,10,"Lista de solicitudes anuladas, $fecha",0,0,'C');
		$mipdf -> Ln (10);
		$mipdf -> Cell(200,10,"Encargado: $usuario",0,0,'L');
		$mipdf -> Ln (10);
...
$mipdf -> SetFont('ARIAL','B', 9);
$mipdf -> SetFillColor(0, 191, 255);
	$mipdf -> Cell(35,11,"Motivo",1,0,'C',true);

...
class MiPDF extends FPDF {
	...
	$mipdf -> Ln (2);
	$mipdf -> Cell('mm',10,utf8_decode("LISTA DE GUÍAS DE REMISIÓN POR ESTADO"),0,0,'C');
	$mipdf -> Ln (10);

	$mipdf -> Setfont('Arial','B',10);
	$mipdf -> Ln (2);
	$mipdf -> Cell('mm',10,utf8_decode("ESTADO DE GUÍA DE REMISIÓN: $estado_movi."),0,0,'L');
	$mipdf -> Ln (2);

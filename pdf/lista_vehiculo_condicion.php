...
$bd = new GestarBD; 
$condicion_vehi=$_GET['condicion_vehi'];
...
class MiPDF extends FPDF {
	...
	$mipdf -> Ln (2);
	$mipdf -> Cell('mm',10,utf8_decode("LISTA DE VEHÍCULOS POR CONDICIÓN"),0,0,'C');
	$mipdf -> Ln (10);

	$mipdf -> Setfont('Arial','B',10);
	$mipdf -> Ln (2);
	$mipdf -> Cell('mm',10,utf8_decode("CONDICIÓN: $condicion_vehi."),0,0,'L');
	$mipdf -> Ln (10);
	...
	$mipdf -> SetFont('ARIAL','B', 9);
	$mipdf -> SetFillColor(0, 191, 255);
	$mipdf -> Cell(35,11,utf8_decode("Tipo de vehículo"),1,0,'C',true);	
	...
	while ( $datos = $bd-> mostrar_registros($sql2))
	{
	    ...
	    $mipdf -> Cell(35,5,utf8_decode("$tipo"),1,0,'C');
		...
		$mipdf -> Cell(32,5,utf8_decode("$marca"),1,0,'C');
		$mipdf -> Cell(30,5,utf8_decode("$color"),1,0,'C');

...
class MiPDF extends FPDF {
	...
	$mipdf -> Ln (2);
	$mipdf -> Cell('mm',10,utf8_decode("LISTA DE COBROS POR ESTADO DE COBRANZA"),0,0,'C');
	$mipdf -> Ln (10);

	$mipdf -> Setfont('Arial','B',10);
	$mipdf -> Ln (2);
	$mipdf -> Cell('mm',10,utf8_decode("ESTADO DE COBRANZA: $estado_movi."),0,0,'L');
	$mipdf -> Ln (2);

                                ...
                                <form role="form"  name="fe" action="?mod=sucursales&nuevo=nuevo" method="post">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleInputFile">Base <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Solo se permiten letras (a-z), números (0-9) y especiales (&.). Se requieren (3-50) caracteres." onclick="Swal.fire({title:'<h2>Letras (a-z)<br>'+'Números (0-9)<br>'+'Especiales (&.)<br>Caracteres (3-50)</h2>',type:'info',showCloseButton:true,focusConfirm:false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"></label>
                                            <input  onkeypress="return check(event)" onblur="this.value=this.value.toUpperCase();" type="text" required type="text" name="nombre" class="form-control faa-float animated-hover" id="exampleInputEmail1" pattern='.{3,50}' maxlength="50" placeholder="Introducir el nombre de la sede" autofocus>
                                            ...
                                            <input onkeydown="return enteros(this, event)" type="tel" name="telefono" class="form-control faa-float animated-hover" id="exampleInputEmail1" pattern='.{7,9}' maxlength="9" placeholder="Introducir el número de teléfono">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="box">
                                <ul class="nav nav-tabs" style="font-weight: bold; font-size: 15px;">
                                  <li class="active"><a data-toggle="tab" href="#sucursales">Nuestras sucursales</a></li>
                                  <li><a data-toggle="tab" href="#ubicacion">Localidades del Perú</a></li>
                                </ul>
...
if ($tipo2==1) {
      ...
      if ($fila['condicion_suc']=='ACTIVO') { echo"
      ...
      ";}
                            ...
                            <div id="ubicacion" class="tab-pane fade">
                                <div class="box-header">
                                    <h3 class="box-title">LOCALIDADES | Departamentos, provincias y distritos del Perú</h3><br><br>
                                    <h4> * Se toma en consideración a la provincia constitucional del Callao como departamento.</h4>
                                </div><!-- /.box-header -->
                                <div class="box-body table-responsive">
                                    <table id="example2" class="table table-bordered table-striped">
                                        ...
                                        $consulta="SELECT nombre_depa, nombre_provi, nombre_dist FROM departamentos, provincias, distritos WHERE departamentos.id_departamento=provincias.id_departamento AND provincias.id_provincia=distritos.id_provincia ORDER BY nombre_depa ASC";
  ...
  <div class="col-md-12">
        ...
        ?>
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleInputFile">Base <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Solo se permiten letras (a-z), números (0-9) y especiales (&.). Se requieren (3-50) caracteres." onclick="Swal.fire({title:'<h2>Letras (a-z)<br>'+'Números (0-9)<br>'+'Especiales (&.)<br>Caracteres (3-50)</h2>',type:'info',showCloseButton:true,focusConfirm:false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"></label>
                                            <input  onkeypress="return check(event)" onblur="this.value=this.value.toUpperCase();" type="text" required type="text" name="nombre" class="form-control faa-float animated-hover" id="exampleInputEmail1" pattern='.{3,50}' maxlength="50" value='<?php echo $fila['nombre_suc']; ?>' placeholder="Introducir el nombre de la sede">
                                            ...
                                            <label for="exampleInputFile">Teléfono <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Solo se permiten números (0-9). Se requieren (7-9) caracteres." onclick="Swal.fire({title:'<h2>Números (0-9)<br>'+'Caracteres (7-9)</h2>',type:'info',showCloseButton:true,focusConfirm:false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"> <code>(Puede ser omitido)</code></label>
                                            <input onkeydown="return enteros(this, event)" type="tel" name="telefono" class="form-control faa-float animated-hover" id="exampleInputEmail1" value="<?php if($fila['telefono_suc']=='0') { echo "";} else echo $fila['telefono_suc'] ?>" pattern='.{7,9}' maxlength="9" placeholder="Introducir el número de teléfono">
...
///////////////------////////////
     ...
     $consulta="SELECT sucursales.id_sucursal, sucursales.id_departamento, sucursales.id_provincia, sucursales.id_distrito, nombre_suc, direccion_suc, nombre_depa, nombre_provi, nombre_dist, telefono_suc, email_suc FROM sucursales, departamentos, provincias, distritos WHERE sucursales.id_sucursal='$x1' AND sucursales.id_departamento=departamentos.id_departamento AND sucursales.id_provincia=provincias.id_provincia AND condicion_suc='ACTIVO' AND sucursales.id_distrito=distritos.id_distrito";
  ...
  <div class="col-md-12">
        ...
        ?>
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleInputFile">Base <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Solo se permiten letras (a-z), números (0-9) y especiales (&.). Se requieren (3-50) caracteres." onclick="Swal.fire({title:'<h2>Letras (a-z)<br>'+'Números (0-9)<br>'+'Especiales (&.)<br>Caracteres (3-50)</h2>',type:'info',showCloseButton:true,focusConfirm:false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"></label>
                                            <input  onkeypress="return check(event)" onblur="this.value=this.value.toUpperCase();" type="text" required type="text" name="nombre" class="form-control faa-float animated-hover" id="exampleInputEmail1" pattern='.{3,50}' maxlength="50" value='<?php echo $fila['nombre_suc']; ?>' placeholder="Introducir el nombre de la sede" disabled>
                                            ...
                                            <label for="exampleInputFile">Teléfono <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Solo se permiten números (0-9). Se requieren (7-9) caracteres." onclick="Swal.fire({title:'<h2>Números (0-9)<br>'+'Caracteres (7-9)</h2>',type:'info',showCloseButton:true,focusConfirm:false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"> <code>(Puede ser omitido)</code></label>
                                            <input onkeydown="return enteros(this, event)" type="text" name="telefono" class="form-control faa-float animated-hover" id="exampleInputEmail1" value="<?php if($fila['telefono_suc']=='0' || $fila['telefono_suc']==null) { echo "SIN TELÉFONO";} else echo $fila['telefono_suc'] ?>" pattern='.{7,9}' maxlength="9" placeholder="Introducir el número de teléfono" disabled>

...
$sql="select * from vehiculos where tipo_vehi='$tipo' AND placa_vehi='$placa' AND constancia_vehi='$constancia' AND marca_vehi='$marca'";
...
$sql2="INSERT INTO `vehiculos` ( `id_propietario`, `tipo_vehi`, `placa_vehi`, `constancia_vehi`, `marca_vehi`, `color_vehi`, `condicion_vehi` ) VALUES ( '$propietario', '$tipo', '$placa', '$constancia', '$marca', '$color', '$condicion' )";
                                ...
                                <form role="form"  name="fe" action="?mod=vehiculos&nuevo=nuevo" method="post">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <label for="exampleInputFile">Placa del vehículo <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Solo se permiten letras (a-z) y números (0-9). Se requieren (6) caracteres." onclick="Swal.fire({title:'<h2>Letras (a-z)<br>'+'Números (0-9)<br>'+'Caracteres (6)</h2>',type:'info',showCloseButton:true,focusConfirm:false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"></label>
                                            <input onkeypress="return spaceout(event)" onblur="this.value=this.value.toUpperCase();" type="text" name="placa" class="form-control faa-float animated-hover" id="exampleInputEmail1" pattern='.{6,6}' maxlength="6" placeholder="Introducir la placa del vehículo" required>
                                            ...
                                            <input onkeypress="return spaceout(event)" onblur="this.value=this.value.toUpperCase();" type="text" name="carreta" class="form-control faa-float animated-hover" id="exampleInputEmail1" pattern='.{6,6}' maxlength="6" placeholder="Introducir la placa de la carreta">

                                            <label for="exampleInputFile">Constancia <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Solo se permiten números (0-9). Se requieren (9) caracteres." onclick="Swal.fire({title:'<h2>Números (0-9)<br>'+'Caracteres (9)</h2>',type:'info',showCloseButton:true,focusConfirm:false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"></label>
                                            <input onkeydown="return enteros(this, event)" type="text" name="constancia" class="form-control faa-float animated-hover" id="exampleInputEmail1" pattern='.{9,9}' maxlength="9" placeholder="Introducir la constancia" required>
...
<div class="col-md-3">
  <div class="box">
                                ...
                                <center>
                                <div class="box-header">
                                   <h3> <center>Lista de medios</center></h3>
                                </div>
        ...
        ?>
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <label for="exampleInputFile">Placa del vehículo <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Solo se permiten letras (a-z) y números (0-9). Se requieren (6) caracteres." onclick="Swal.fire({title:'<h2>Letras (a-z)<br>'+'Números (0-9)<br>'+'Caracteres (6)</h2>',type:'info',showCloseButton:true,focusConfirm:false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"></label>
                                            <input onkeypress="return spaceout(event)" onblur="this.value=this.value.toUpperCase();" type="text" name="placa" class="form-control faa-float animated-hover" id="exampleInputEmail1" pattern='.{6,6}' maxlength="6" placeholder="Introducir la placa del vehículo" required value="<?php echo $fila['placa_vehi']?>">

                                            <label for="exampleInputFile">Placa de la carreta <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Solo se permiten letras (a-z) y números (0-9). Se requieren (6) caracteres." onclick="Swal.fire({title:'<h2>Letras (a-z)<br>'+'Números (0-9)<br>'+'Caracteres (6)</h2>',type:'info',showCloseButton:true,focusConfirm:false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"> <code>(Puede ser omitido)</code></label>
                                            <input onkeypress="return spaceout(event)" onblur="this.value=this.value.toUpperCase();" type="text" name="carreta" class="form-control faa-float animated-hover" id="exampleInputEmail1" pattern='.{6,6}' maxlength="6" placeholder="Introducir la placa de la carreta" value="<?php echo $fila['placa_carreta']?>">

                                            <label for="exampleInputFile">Constancia <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Solo se permiten números (0-9). Se requieren (9) caracteres." onclick="Swal.fire({title:'<h2>Números (0-9)<br>'+'Caracteres (9)</h2>',type:'info',showCloseButton:true,focusConfirm:false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"></label>
                                            <input onkeydown="return enteros(this, event)" type="text" name="constancia" class="form-control faa-float animated-hover" id="exampleInputEmail1" pattern='.{9,9}' maxlength="9" placeholder="Introducir la constancia" required value="<?php echo $fila['constancia_vehi']?>">
        ...
        ?>
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <label for="exampleInputFile">Placa del vehículo <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Solo se permiten letras (a-z) y números (0-9). Se requieren (6) caracteres." onclick="Swal.fire({title:'<h2>Letras (a-z)<br>'+'Números (0-9)<br>'+'Caracteres (6)</h2>',type:'info',showCloseButton:true,focusConfirm:false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"></label>
                                            <input onkeypress="return spaceout(event)" onblur="this.value=this.value.toUpperCase();" type="text" name="placa" class="form-control faa-float animated-hover" id="exampleInputEmail1" pattern='.{6,6}' maxlength="6" placeholder="Introducir la placa del vehículo" required value="<?php echo $fila['placa_vehi']?>" disabled>

                                            <label for="exampleInputFile">Placa de la carreta <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Solo se permiten letras (a-z) y números (0-9). Se requieren (6) caracteres." onclick="Swal.fire({title:'<h2>Letras (a-z)<br>'+'Números (0-9)<br>'+'Caracteres (6)</h2>',type:'info',showCloseButton:true,focusConfirm:false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"> <code>(Puede ser omitido)</code></label>
                                            <input onkeypress="return spaceout(event)" onblur="this.value=this.value.toUpperCase();" type="text" name="carreta" class="form-control faa-float animated-hover" id="exampleInputEmail1" pattern='.{6,6}' maxlength="6" placeholder="Introducir la placa de la carreta" value="<?php if($fila['placa_carreta']=='') { echo "SIN PLACA";} else echo $fila['placa_carreta'] ?>" disabled>

                                            <label for="exampleInputFile">Constancia <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Solo se permiten números (0-9). Se requieren (9) caracteres." onclick="Swal.fire({title:'<h2>Números (0-9)<br>'+'Caracteres (9)</h2>',type:'info',showCloseButton:true,focusConfirm:false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"></label>
                                            <input onkeydown="return enteros(this, event)" type="text" name="constancia" class="form-control faa-float animated-hover" id="exampleInputEmail1" pattern='.{9,9}' maxlength="9" placeholder="Introducir la constancia" required value="<?php echo $fila['constancia_vehi']?>" disabled>

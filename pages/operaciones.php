...
$buscar_imp_ope2 = "SELECT categoria_ope FROM operaciones GROUP BY categoria_ope ORDER BY categoria_ope";
$resultado_imp_ope2 = mysqli_query(mysqli_connect("$servidor","$usuario","$pass","$basedatos"),$buscar_imp_ope2);
...
$categoria=trim(strtoupper($_POST["categoria"]));

$sql="select * from operaciones where descripcion_ope='$nombre' AND tipo_ope='$tipo' AND categoria_ope='$categoria'";
...
$sql2="INSERT INTO `operaciones` ( `descripcion_ope`, `tipo_ope`, `categoria_ope`) VALUES ('$nombre', '$tipo', '$categoria')";
                                ...
                                <form role="form"  name="fe" action="?mod=operaciones&nuevo=nuevo" method="post">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleInputFile">Descripción <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Solo se permiten letras (a-z). Se requieren (2-50) caracteres." onclick="Swal.fire({title:'<h2>Letras (a-z)<br>'+'Caracteres (2-50)</h2>',type:'info',showCloseButton:true,focusConfirm:false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"></label>
                                            <input  onkeypress="return caracteres(event)" onblur="this.value=this.value.toUpperCase();" type="text" required type="text" name="nombre" class="form-control faa-float animated-hover" id="exampleInputEmail1" pattern='.{2,50}' maxlength="50" placeholder="Introducir la descripción" autofocus>
                                            ...
                                            <label for="exampleInputFile">Tipo de operación <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Se requiere escoger un tipo de operación." onclick="Swal.fire({title:'<h2>Por favor seleccione un tipo de operación</h2>',type:'info',showCloseButton:true,focusConfirm: false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"></label>
                                                <select for="exampleInputEmail" class="btn btn-primary faa-float animated-hover" name='tipo' required>
                                                   <option class="btn-primary" value="EGRESOS">EGRESOS</option>
                                                   <option class="btn-primary" value="INGRESOS">INGRESOS</option>
                                                </select>
                                            ...
                                            <label for="exampleInputFile">Categoría de operación <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Se requiere escoger una categoría de operación." onclick="Swal.fire({title:'<h2>Por favor seleccione una categoría de operación</h2>',type:'info',showCloseButton:true,focusConfirm: false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"></label>
                                                <select for="exampleInputEmail" class="btn btn-primary faa-float animated-hover" name='categoria' required>
                                                   <option class="btn-primary" value="ADMINISTRATIVO-OFICINA">ADMINISTRATIVO-OFICINA</option>
                                                   <option class="btn-primary" value="CONTINGENCIA">CONTINGENCIA</option>
                                                   <option class="btn-primary" value="DOCUMENTOS-TRAMITES">DOCUMENTOS-TRÁMITES</option>
                                                   <option class="btn-primary" value="OPERATIVIDAD">OPERATIVIDAD</option>
                                                   <option class="btn-primary" value="PERSONAL Y OBLIGACIONES SOCIALES">PERSONAL Y OBLIGACIONES SOCIALES</option>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="faa-float animated-hover">Categoría</th>
                                        ...
                                        $consulta="SELECT operaciones.id_operacion, descripcion_ope, tipo_ope, categoria_ope FROM operaciones ORDER BY descripcion_ope ASC";
...
<div class="col-md-3">
  <div class="box">
                                ...
                                <label for="exampleInputFile">Tipo de operación <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Se requiere escoger un tipo para exportar." onclick="Swal.fire({title:'<h2>Exportar PDF de operaciones por tipo</h2>',type:'info',showCloseButton:true,focusConfirm:false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"></label>
                                            <select target='_blank' class='btn btn-primary faa-float animated-hover' for="exampleInputFile" name="imprimir_operacion_tipo" onchange="if(this.value=='Seleccione un tipo para exportar'){} else { window.open(this.value,'_blank');}">
                                                <option class="btn-danger">Seleccione un tipo para exportar</option>
                                                <?php while($OPE = mysqli_fetch_assoc($resultado_imp_ope)): ?>
                                                    <option class="btn-primary" value='./pdf/lista_operacion_tipo.php?tipo_ope=<?php echo $OPE['tipo_ope']?>'><?php echo $OPE['tipo_ope'] ?></option>
                                                <?php endwhile; 
                                                ?>
                                            </select>

                                <label for="exampleInputFile">Categoría de operación <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Se requiere escoger una categoría para exportar." onclick="Swal.fire({title:'<h2>Exportar PDF de operaciones por categoría</h2>',type:'info',showCloseButton:true,focusConfirm:false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"></label>
                                            <select target='_blank' class='btn btn-primary faa-float animated-hover' for="exampleInputFile" name="imprimir_operacion_categoria" onchange="if(this.value=='Seleccione una categoría para exportar'){} else { window.open(this.value,'_blank');}">
                                                <option class="btn-danger">Seleccione una categoría para exportar</option>
                                                <?php while($OPE2 = mysqli_fetch_assoc($resultado_imp_ope2)): ?>
                                                    <option class="btn-primary" value='./pdf/lista_operacion_categoria.php?categoria_ope=<?php echo $OPE2['categoria_ope']?>'><?php echo $OPE2['categoria_ope'] ?></option>
                                                <?php endwhile; 
                                                ?>
                                            </select>
...
$bd->consulta($sql22);
 ...
 <input title="REGRESAR A LA LISTA" name="btn1"  class="btn btn-primary"type="submit" value="Regresar a lista">
     ...
     $consulta="SELECT id_operacion, descripcion_ope, tipo_ope, categoria_ope FROM operaciones WHERE id_operacion='$x1'";
     $bd->consulta($consulta);
     while ($fila=$bd->mostrar_registros()) {
  ...
  <div class="col-md-12">
        ...
        ?>
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleInputFile">Descripción <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Solo se permiten letras (a-z). Se requieren (2-50) caracteres." onclick="Swal.fire({title:'<h2>Letras (a-z)<br>'+'Caracteres (2-50)</h2>',type:'info',showCloseButton:true,focusConfirm:false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"></label>
                                            <input  onkeypress="return caracteres(event)" onblur="this.value=this.value.toUpperCase();" type="text" required type="text" name="nombre" class="form-control faa-float animated-hover" value="<?php echo $fila['descripcion_ope'] ?>" id="exampleInputEmail1" pattern='.{2,50}' maxlength="50" placeholder="Introducir la descripción">
                                            ...
                                            <label for="exampleInputFile">Categoría de operación <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Se requiere escoger una categoría de operación." onclick="Swal.fire({title:'<h2>Por favor seleccione una categoría de operación</h2>',type:'info',showCloseButton:true,focusConfirm: false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"></label>
                                                <select for="exampleInputEmail" class="btn btn-primary faa-float animated-hover" name='categoria' required>
                                                   ...
                                                   <option class="btn-primary" value="OPERATIVIDAD">OPERATIVIDAD</option>
                                                   <option class="btn-primary" value="PERSONAL Y OBLIGACIONES SOCIALES">PERSONAL Y OBLIGACIONES SOCIALES</option>
                                                   <option class="btn-primary" value="SIN CATEGORIA">SIN CATEGORIA</option>
                                                </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="exampleInputFile">Tipo de operación <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Se requiere escoger un tipo de operación." onclick="Swal.fire({title:'<h2>Por favor seleccione un tipo de operación</h2>',type:'info',showCloseButton:true,focusConfirm: false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"></label>
                                                <select for="exampleInputEmail" class="btn btn-primary faa-float animated-hover" name='tipo'>
                                                   <option class="btn-danger" value="<?php echo $fila['tipo_ope']?>">ACTUAL: <?php echo $fila['tipo_ope']?></option>
                                                   <option class="btn-primary" value="EGRESOS" disabled>EGRESOS</option>
                                                   <option class="btn-primary" value="INGRESOS" disabled>INGRESOS</option>
                                                </select>

                                            <label for="exampleInputFile">Categoría de operación <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Se requiere escoger una categoría de operación." onclick="Swal.fire({title:'<h2>Por favor seleccione una categoría de operación</h2>',type:'info',showCloseButton:true,focusConfirm: false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"></label>
                                                <select for="exampleInputEmail" class="btn btn-primary faa-float animated-hover" name='categoria' required>
                                                   <option class="btn-danger" value="<?php echo $fila['categoria_ope']?>">ACTUAL: <?php echo $fila['categoria_ope']?></option>
                                                   <option class="btn-primary" value="ADMINISTRATIVO-OFICINA" disabled>ADMINISTRATIVO-OFICINA</option>
                                                   <option class="btn-primary" value="CONTINGENCIA" disabled>CONTINGENCIA</option>
                                                   <option class="btn-primary" value="DOCUMENTOS-TRAMITES" disabled>DOCUMENTOS-TRÁMITES</option>
                                                   <option class="btn-primary" value="OPERATIVIDAD" disabled>OPERATIVIDAD</option>
                                                   <option class="btn-primary" value="PERSONAL Y OBLIGACIONES SOCIALES" disabled>PERSONAL Y OBLIGACIONES SOCIALES</option>
                                                   <option class="btn-primary" value="SIN CATEGORIA" disabled>SIN CATEGORIA</option>
                                                </select>
                                        </div>  
                                    </div><!-- /.box-body --><center>
...
$x1=$_GET['codigo'];
     ...
     $consulta="SELECT operaciones.id_operacion, descripcion_ope, tipo_ope, categoria_ope, CASE WHEN COUNT(movimientos.id_operacion)>=1 THEN 'EJECUTADO' ELSE 'SIN EJECUCIÓN' END AS operaciones FROM operaciones,movimientos WHERE operaciones.id_operacion=movimientos.id_operacion AND operaciones.id_operacion='$x1' ORDER BY descripcion_ope ASC";
        ...
        ?>
                                    <div class="box-body">
                                        <div class="form-group">                   
                                         ...
                                         <tr>
                                         <td>
                                            <h3 class='faa-float animated-hover'> Categoría de operación</h3>
                                            </td><td class='faa-float animated-hover'>
                                         <?php echo $fila['categoria_ope'] ?></td>
                                         </tr>
                                         <tr>
                                         <td>

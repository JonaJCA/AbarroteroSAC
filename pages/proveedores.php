...
$sql2="INSERT INTO `proveedores`(`id_departamento`, `id_provincia`, `id_distrito`, `ruc_prov`, `dni_prov`, `nombre_prov`, `direccion_prov`, `telefono_prov`, `email_prov`, `registro_prov`, `observacion_prov`) VALUES ('$departamento','$provincia','$distrito', '$ruc', '$dni', '$nombre', '$direccion', '$telefono', '$correo', '$fecha2', '$observacion')";
                                ...
                                <form role="form"  name="fe" action="?mod=proveedores&nuevo=nuevo" method="post">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <input onkeypress="return check(event)" onblur="this.value=this.value.toUpperCase();" type="text" required type="tex" name="nombre" class="form-control faa-float animated-hover" id="exampleInputEmail1" placeholder="Introducir el nombre del proveedor" pattern='.{2,30}' maxlength="30" autofocus>
                                            ...
                                            <input  onkeydown="return enteros(this, event)" onblur="this.value=this.value.toUpperCase();" min='10000000000' max='29999999999' step='1' type="number" required name="ruc" class="form-control faa-float animated-hover" id="exampleInputEmail1" placeholder="Introducir el RUC" pattern='.{11,11}' maxlength="11">
                                            ...
                                            <input onkeydown="return enteros(this, event)" type="text" name="dni" class="form-control faa-float animated-hover" id="exampleInputEmail1" placeholder="Introducir el número de DNI" pattern='.{8,8}' maxlength="8">
                                            ...
                                            <input onkeypress="return off(event)" onblur="this.value=this.value.toUpperCase();" type="text" name="direccion" class="form-control faa-float animated-hover" pattern='.{5,100}' maxlength="100" id="exampleInputEmail1" placeholder="Introducir la dirección" required>
        ...
        ?>
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <label for="exampleInputFile">Nombre del proveedor <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Solo se permiten letras (a-z), números (0-9) y especiales (&.). Se requieren (2-30) caracteres." onclick="Swal.fire({title:'<h2>Letras (a-z)<br>'+'Números (0-9)<br>'+'Especiales (&.)<br>Caracteres (5-100)</h2>',type:'info',showCloseButton:true,focusConfirm: false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"></label>
                                            <input onkeypress="return check(event)" onblur="this.value=this.value.toUpperCase();" type="text" required type="tex" name="nombre" class="form-control faa-float animated-hover" id="exampleInputEmail1" placeholder="Introducir el nombre del proveedor" pattern='.{2,30}' maxlength="30" value="<?php echo $fila['nombre_prov']?>" autofocus>
                                            
                                            <label for="exampleInputFile">RUC <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Solo se permiten números (0-9). Se requieren (11) caracteres." onclick="Swal.fire({title:'<h2>Números (0-9)<br>'+'Caracteres (11)</h2>',type:'info',showCloseButton:true,focusConfirm: false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"></label>
                                            <input  onkeydown="return enteros(this, event)" onblur="this.value=this.value.toUpperCase();" min='10000000000' max='29999999999' step='1' required type="number" name="ruc" class="form-control faa-float animated-hover" id="exampleInputEmail1" placeholder="Introducir el RUC" pattern='.{11,11}' maxlength="11" value="<?php echo $fila['ruc_prov']?>">

                                            <label for="exampleInputFile">DNI <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Solo se permiten números (0-9). Se requieren (8) caracteres." onclick="Swal.fire({title:'<h2>Números (0-9)<br>'+'Caracteres (8)</h2>',type:'info',showCloseButton:true,focusConfirm: false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"> <code>(Puede ser omitido)</code></label>
                                            <input onkeydown="return enteros(this, event)" type="text" name="dni" class="form-control faa-float animated-hover" id="exampleInputEmail1" placeholder="Introducir el número de DNI" pattern='.{8,8}' maxlength="8" value="<?php if($fila['dni_prov']=='0') { echo "";} else echo $fila['dni_prov'] ?>">
                                            ...
                                            <label for="exampleInputFile">Dirección <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Solo se permiten letras (a-z), números (0-9) y especiales ( . _ - ). Se requieren (5-100) caracteres." onclick="Swal.fire({title:'<h2>Letras (a-z)<br>'+'Números (0-9)<br>'+'Especiales (._-)<br>'+'Caracteres (5-100)</h2>',type:'info',showCloseButton:true,focusConfirm: false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"></label>
                                            <input onkeypress="return off(event)" onblur="this.value=this.value.toUpperCase();" type="text" name="direccion" class="form-control faa-float animated-hover" pattern='.{5,100}' maxlength="100" id="exampleInputEmail1" placeholder="Introducir la dirección" value="<?php if($fila['direccion_prov']=='') { echo "";} else echo $fila['direccion_prov'] ?>" required>
        ...
        ?>
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <label for="exampleInputFile">Nombre del proveedor <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Solo se permiten letras (a-z), números (0-9) y especiales (&.). Se requieren (2-30) caracteres." onclick="Swal.fire({title:'<h2>Letras (a-z)<br>'+'Números (0-9)<br>'+'Especiales (&.)<br>Caracteres (5-100)</h2>',type:'info',showCloseButton:true,focusConfirm: false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"></label>
                                            <input onkeypress="return check(event)" onblur="this.value=this.value.toUpperCase();" type="text" required type="tex" name="nombre" class="form-control faa-float animated-hover" id="exampleInputEmail1" placeholder="Introducir el nombre del proveedor" pattern='.{2,30}' maxlength="30" value="<?php echo $fila['nombre_prov']?>" disabled>
                                            
                                            <label for="exampleInputFile">RUC <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Solo se permiten números (0-9). Se requieren (11) caracteres." onclick="Swal.fire({title:'<h2>Números (0-9)<br>'+'Caracteres (11)</h2>',type:'info',showCloseButton:true,focusConfirm: false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"></label>
                                            <input  onkeydown="return enteros(this, event)" onblur="this.value=this.value.toUpperCase();" type="number" required type="text" name="ruc" class="form-control faa-float animated-hover" id="exampleInputEmail1" placeholder="Introducir el RUC" pattern='.{11,11}' maxlength="11" value="<?php echo $fila['ruc_prov']?>" disabled>

                                            <label for="exampleInputFile">DNI <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Solo se permiten números (0-9). Se requieren (8) caracteres." onclick="Swal.fire({title:'<h2>Números (0-9)<br>'+'Caracteres (8)</h2>',type:'info',showCloseButton:true,focusConfirm: false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"> <code>(Puede ser omitido)</code></label>
                                            <input onkeydown="return enteros(this, event)" type="text" name="dni" class="form-control faa-float animated-hover" id="exampleInputEmail1" placeholder="Introducir el número de DNI" pattern='.{8,8}' maxlength="8" value="<?php if($fila['dni_prov']=='0') { echo "SIN REGISTRO";} else echo $fila['dni_prov'] ?>" disabled>
        ...
        ?>
                                    <div class="box-body">
                                        <div class="form-group">
                                         ...
                                         <?php echo '<b>RUC:</b> '.$fila['ruc_prov'] ?><br>
                                         <?php echo '<b>DNI:</b> '.$fila['dni_prov'] ?></td>
                                         </tr>
                                         <tr>
                                         <td>
                                            <h3 class='faa-float animated-hover'> Contacto</h3>
                                            </td><td class='faa-float animated-hover'>
                                         <?php echo '<b>TELÉFONO:</b> '.$fila['telefono_prov'] ?><br>
                                         <?php echo '<b>CORREO ELECTRÓNICO:</b> '.$fila['email_prov'] ?></td>
                                         </tr>
                                         <tr>
                                         <td>

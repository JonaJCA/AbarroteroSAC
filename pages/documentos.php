...
$buscar_imp_doc = "SELECT tipo_doc FROM documentos WHERE tipo_doc != 'NINGUNO' GROUP BY tipo_doc ";
                                ...
                                <form role="form"  name="fe" action="?mod=documentos&nuevo=nuevo" method="post">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleInputFile">Nombre del documento <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Solo se permiten letras (a-z). Se requieren (2-100) caracteres." onclick="Swal.fire({title:'<h2>Letras (a-z)<br>'+'Caracteres (2-100)</h2>',type:'info',showCloseButton:true,focusConfirm:false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"></label>
                                            <input  onkeypress="return caracteres(event)" onblur="this.value=this.value.toUpperCase();" type="text" required type="text" name="nombre" class="form-control faa-float animated-hover" id="exampleInputEmail1" pattern='.{2,100}' maxlength="100" placeholder="Introducir el nombre" autofocus>
                                            ...
                                            <label for="exampleInputFile">Tipo de documento <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Se requiere escoger un tipo de documento." onclick="Swal.fire({title:'<h2>Por favor seleccione un tipo de documento</h2>',type:'info',showCloseButton:true,focusConfirm:false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"></label>
                                                <select  for="exampleInputEmail" class="btn btn-primary faa-float animated-hover" name='tipo' required>
                                                   <option class='btn-primary' value="COMPROBANTES COMUNES">COMPROBANTES COMUNES</option>                   
                                                   <option class='btn-primary' value="COMPROBANTES DE PERCEPCION">COMPROBANTES DE PERCEPCIÓN</option>
                                                   <option class='btn-primary' value="COMPROBANTES DE TRANSPORTE">COMPROBANTES DE TRANSPORTE</option>
                                                   <option class='btn-primary' value="COMPROBANTES ELECTRONICOS">COMPROBANTES ELECTRÓNICOS</option>
                                                   <option class='btn-primary' value="COMPROBANTES TRIBUTARIOS">COMPROBANTES TRIBUTARIOS</option>
                                                   <option class='btn-primary' value="ESCRITOS DE REVISION TECNICA">ESCRITOS DE REVISIÓN TÉCNICA</option>
                                                   <option class='btn-primary' value="RECIBOS DE AVIACION">RECIBOS DE AVIACIÓN</option>
                                                   <option class='btn-primary' value="RECIBOS FERROVIARIOS">RECIBOS FERROVIARIOS</option>
                                                   <option class='btn-primary' value="TARJETAS DE CREDITO Y COBRANZA">TARJETAS DE CRÉDITO Y COBRANZA</option>
                                                   <option class='btn-primary' value="VARIOS Y OTROS DOCUMENTOS">VARIOS Y OTROS DOCUMENTOS</option>
                                                </select>
                                        </div>
                                    </div><!-- /.box-body -->
                                    <center>
...
?>
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">DOCUMENTOS | Lista de escritos</h3>                                    
                                </div><!-- /.box-header -->
  ...
  <div class="col-md-12">
        ...
        ?>
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleInputFile">Nombre del documento <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Solo se permiten letras (a-z). Se requieren (2-100) caracteres." onclick="Swal.fire({title:'<h2>Letras (a-z)<br>'+'Caracteres (2-100)</h2>',type:'info',showCloseButton:true,focusConfirm:false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"></label>
                                            <input  onkeypress="return caracteres(event)" onblur="this.value=this.value.toUpperCase();" type="text" required type="text" name="nombre" class="form-control faa-float animated-hover" value="<?php echo $fila['nombre_doc'] ?>" id="exampleInputEmail1" pattern='.{2,100}' maxlength="100" placeholder="Introducir el nombre">
  ...
  <div class="col-md-12">
        ...
        ?>
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleInputFile">Nombre del documento <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Solo se permiten letras (a-z). Se requieren (2-100) caracteres." onclick="Swal.fire({title:'<h2>Letras (a-z)<br>'+'Caracteres (2-100)</h2>',type:'info',showCloseButton:true,focusConfirm:false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"></label>
                                            <input  onkeypress="return caracteres(event)" onblur="this.value=this.value.toUpperCase();" type="text" required type="text" name="nombre" class="form-control faa-float animated-hover" value="<?php echo $fila['nombre_doc'] ?>" id="exampleInputEmail1" pattern='.{2,100}' maxlength="100" placeholder="Introducir el nombre" disabled>

                                            <label for="exampleInputFile">Tipo de documento <img width="15px" height="15px" frameborder="0" src="img/info.png" title="Se requiere escoger un tipo de documento." onclick="Swal.fire({title:'<h2>Por favor seleccione un tipo de documento</h2>',type:'info',showCloseButton:true,focusConfirm:false,confirmButtonText:'<h4>ENTENDIDO</h4>',})"></label>
                                                <select  for="exampleInputEmail" class="btn btn-primary faa-float animated-hover" name='tipo' required>
                                                   <option class="btn-danger" value="<?php echo $fila['tipo_doc']?>">ACTUAL: <?php echo $fila['tipo_doc']?></option>
                                                   <option class='btn-primary' value="COMPROBANTES COMUNES" disabled>COMPROBANTES COMUNES</option>                   
                                                   <option class='btn-primary' value="COMPROBANTES DE PERCEPCION" disabled>COMPROBANTES DE PERCEPCIÓN</option>
                                                   <option class='btn-primary' value="COMPROBANTES DE TRANSPORTE" disabled>COMPROBANTES DE TRANSPORTE</option>
                                                   <option class='btn-primary' value="COMPROBANTES ELECTRONICOS" disabled>COMPROBANTES ELECTRÓNICOS</option>
                                                   <option class='btn-primary' value="COMPROBANTES TRIBUTARIOS" disabled>COMPROBANTES TRIBUTARIOS</option>
                                                   <option class='btn-primary' value="ESCRITOS DE REVISION TECNICA" disabled>ESCRITOS DE REVISIÓN TÉCNICA</option>
                                                   <option class='btn-primary' value="RECIBOS DE AVIACION" disabled>RECIBOS DE AVIACIÓN</option>
                                                   <option class='btn-primary' value="RECIBOS FERROVIARIOS" disabled>RECIBOS FERROVIARIOS</option>
                                                   <option class='btn-primary' value="TARJETAS DE CREDITO Y COBRANZA" disabled>TARJETAS DE CRÉDITO Y COBRANZA</option>                                  
                                                   <option class='btn-primary' value="VARIOS Y OTROS DOCUMENTOS" disabled>VARIOS Y OTROS DOCUMENTOS</option>
                                                </select>
                                        </div>  
                                    </div><!-- /.box-body --><center>
